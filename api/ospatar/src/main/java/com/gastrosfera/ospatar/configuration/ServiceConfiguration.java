package com.gastrosfera.ospatar.configuration;
...
@EntityScan(basePackages = {"com.gastrosfera.ospatar.model"})
@EnableJpaRepositories(basePackages = {"com.gastrosfera.ospatar.repository"})
